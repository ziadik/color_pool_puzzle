...
class StackNavigation extends StatelessWidget {
  const StackNavigation({super.key, required this.index, required this.selectedIndex, required this.pages, required this.onResetStack});
    ...
    return Offstage(
      ...
      child: Navigator(
        ...
        onDidRemovePage: (Page<Object?> removedPage) {
          // Если удалённая страница совпадает с верхней,
