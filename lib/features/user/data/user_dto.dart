...
final class UserDto {
  ...
  const UserDto({required this.id, required this.username, required this.score});

  /// Преобразование JSON в DTO
  /// [json] - JSON-данные полученные от сервера
  factory UserDto.fromJson(Map<String, dynamic> json) {
    return UserDto(id: json['id'] as int, username: json['username'] as String, score: json['score'] ?? 0);
  }
