...
final class LeaderboardDto {
  ...
  const LeaderboardDto({required this.id, required this.username, required this.score});

  /// Создание объекта из JSON
  /// [json] - JSON-объект, полученный из API бэкенда
  factory LeaderboardDto.fromJson(Map<String, dynamic> json) {
    return LeaderboardDto(id: json['id'] as int, username: json['username'] as String, score: json['score'] ?? 0);
  }
