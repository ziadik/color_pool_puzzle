...
Future<Depends>? _$initializeApp;

/// Initializes the app and prepares it for use.
Future<Depends> $initializeApp({
  void Function(int progress, String message)? onProgress,
  FutureOr<void> Function(Depends dependencies)? onSuccess,
  void Function(Object error, StackTrace stackTrace)? onError,
}) => _$initializeApp ??= Future<Depends>(() async {
  ...
  try {
    ...
    final dependencies = await $initializeDepends(onProgress: onProgress).timeout(const Duration(minutes: 7));
...
@visibleForTesting
Future<void> $resetApp(Depends dependencies) async {}

/// Disposes the app and releases all resources.
@visibleForTesting
Future<void> $disposeApp(Depends dependencies) async {}
