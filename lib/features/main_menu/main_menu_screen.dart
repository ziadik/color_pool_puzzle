...
class MainMenuScreen extends StatelessWidget {
  ...
  Widget _buildLanguageSwitcher(BuildContext context) {
    ...
    return Column(
      children: [
        Text(l10n.language, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
        SizedBox(height: 8),
        Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            // Английский язык
            _buildLanguageOption(context: context, languageCode: 'en', languageName: l10n.english, isSelected: currentLocale == 'en'),
            SizedBox(width: 16),
            // Русский язык
            _buildLanguageOption(context: context, languageCode: 'ru', languageName: l10n.russian, isSelected: currentLocale == 'ru'),
          ],
        ),
      ],
    );
  ...
  Widget _buildLanguageOption({required BuildContext context, required String languageCode, required String languageName, required bool isSelected}) {
