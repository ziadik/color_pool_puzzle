...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1202: x0 => x0.length,
      _1284: () => new AudioContext(),
      _1285: (x0,x1) => x0.createMediaElementSource(x1),
      _1286: x0 => x0.createStereoPanner(),
      _1287: (x0,x1) => x0.connect(x1),
      _1288: x0 => x0.load(),
      _1289: x0 => x0.disconnect(),
      _1290: x0 => x0.remove(),
      _1291: x0 => x0.resume(),
      _1292: x0 => x0.play(),
      _1293: x0 => x0.pause(),
      ...
      _1296: (x0,x1) => x0.removeItem(x1),
      _1297: (x0,x1,x2) => x0.setItem(x1,x2),
      _1298: x0 => x0.deviceMemory,
      _1299: Date.now,
      ...
      _1377: (t, s) => t.set(s),
      _1378: l => new DataView(new ArrayBuffer(l)),
      ...
      _1430: x0 => x0.abort(),
      _1431: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1432: (x0,x1) => globalThis.fetch(x0,x1),
      _1433: (x0,x1) => x0.get(x1),
      _1434: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1434(f,arguments.length,x0,x1,x2) }),
      _1435: (x0,x1) => x0.forEach(x1),
      _1436: x0 => x0.getReader(),
      _1437: x0 => x0.cancel(),
      _1438: x0 => x0.read(),
      _1445: (x0,x1) => x0.createElement(x1),
      ...
      _2320: (x0,x1) => { x0.crossOrigin = x1 },
      _2323: (x0,x1) => { x0.preload = x1 },
      _2327: x0 => x0.currentTime,
      _2328: (x0,x1) => { x0.currentTime = x1 },
      _2329: x0 => x0.duration,
      _2334: (x0,x1) => { x0.playbackRate = x1 },
      _2343: (x0,x1) => { x0.loop = x1 },
      _2347: (x0,x1) => { x0.volume = x1 },
      _2364: x0 => x0.code,
      _2365: x0 => x0.message,
      ...
      _3852: x0 => x0.maxTouchPoints,
      _3859: x0 => x0.appCodeName,
      _3860: x0 => x0.appName,
      _3861: x0 => x0.appVersion,
      _3862: x0 => x0.platform,
      _3863: x0 => x0.product,
      _3864: x0 => x0.productSub,
      _3865: x0 => x0.userAgent,
      _3866: x0 => x0.vendor,
      _3867: x0 => x0.vendorSub,
      _3869: x0 => x0.language,
      _3870: x0 => x0.languages,
      _3876: x0 => x0.hardwareConcurrency,
      _4073: x0 => x0.length,
      _5461: x0 => x0.destination,
      _5465: x0 => x0.state,
      _6014: x0 => x0.signal,
      _6071: x0 => x0.baseURI,
